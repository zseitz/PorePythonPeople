...
- Assistant text panes (chat, follow-ups, request preview, timeline) render lightweight markdown formatting for readability (headings/lists/inline code/fenced code blocks).
